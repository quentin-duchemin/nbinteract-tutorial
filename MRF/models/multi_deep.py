...
class model(BaseModel):
	def __init__(self, nb_params=None, projection=None, ghost=False):
		...
		if not self.ghost:
			self.fc10 = nn.Linear(666, 108)
			self.fc11 = nn.Linear(666, 108)
			self.fc12 = nn.Linear(666, 108)
			self.fc13 = nn.Linear(666, 108)
			self.fc14 = nn.Linear(666, 108)
			self.fc15 = nn.Linear(666, 108)
			self.fc16 = nn.Linear(666, 108)
			self.fc17 = nn.Linear(666, 108)
			self.fc18 = nn.Linear(666, 108)
			self.fc19 = nn.Linear(666, 108)
			
						
			
			self.fc2 = nn.Linear(30, 2048)
			...
			self.fc24 = nn.Linear(1024, 768)
			self.bn24 = nn.BatchNorm1d(768)
	...
	def forward(self, s):
		...
		s = self.avg3(self.conv3(self.avg2(self.conv2(self.avg1(self.conv1(s))))))
		...
		s = F.relu(self.bn24(self.fc24(s)))
