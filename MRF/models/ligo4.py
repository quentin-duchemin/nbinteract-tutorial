...
class model(BaseModel):
	def __init__(self, nb_params=None, projection=None, ghost=False):
		...
		if not self.ghost:
			...
			self.fc3  = nn.Linear(128, 448)
			self.fc4  = nn.Linear(448, 1024)
	...
	def forward(self, s):
		...
		s128 = F.relu(self.fc2(s))
		s448 = F.relu(self.fc3(s128))
		s = F.relu(self.fc4(s448))
		s = s.unsqueeze(1)
		...
		s = F.relu(self.fc10(s448+s))
		s = F.relu(self.fc11(s))
		s = F.relu(self.fc12(s128+s))
